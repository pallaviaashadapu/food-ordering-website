...
function displayItems(){
    ...
    var beverage=document.getElementById('beverages');
    ...
    const desertData= foodItem.filter((item)=>item.category=='Deserts');
    console.log(desertData);
    const beverageData=foodItem.filter((item)=>item.category=='Hot Beverage');
